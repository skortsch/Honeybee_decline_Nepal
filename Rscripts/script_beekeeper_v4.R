...
head(NA)
#is.na(hd)
#hd<-read.table("clipboard")
#write.csv(hd, "../Data/historic_honeybee_data_90s.csv", row.names=T)
...
#beehive historic
  no_hives_90s<-hd[,c(2:6)]
#convert table
  bh_t_90s <- pivot_longer(no_hives_90s[,-c(1,2)],cols = c("1997", "1996", "1995"), names_to = "year")
