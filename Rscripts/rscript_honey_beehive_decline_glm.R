...
#hy[,5]<-as.numeric(hy[,5])
#hy[,6]<-as.numeric(hy[,6])
#hy[,7]<-as.numeric(hy[,7])
#hy[,8]<-as.numeric(hy[,8])
...
###Summary output for the glm log link regression
summary(bh_glm)
1-3381/3650 #=0.07369863 the model accounts for 7% of the deviance in the data
#Wald test
